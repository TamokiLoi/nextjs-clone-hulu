...
const Thumbnail = (result: MovieModel) => {
    const BASE_URL = 'https://image.tmdb.org/t/p/original/';
    return (
        <>
            {result && (
                <div
                    className="group p-2 cursor-pointer transition duration-200 ease-in transform
                    ...
                    <Image
                        ...
                        width={1920}
                        height={1080}
                        alt={result.title || result.original_title || result.name}
                    />
